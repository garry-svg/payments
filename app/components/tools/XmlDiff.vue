  ...
  <div class="flex flex-col gap-5 h-full">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="flex flex-col gap-2">
        <div class="flex items-center justify-between px-2">
          <div class="flex items-center gap-2">
            <span class="text-xs font-bold text-slate-500 uppercase tracking-wider font-mono">Left XML</span>
            <span 
              v-if="leftError" 
      ...
      <div class="flex flex-col gap-2">
        <div class="flex items-center justify-between px-2">
          <div class="flex items-center gap-2">
            <span class="text-xs font-bold text-slate-500 uppercase tracking-wider font-mono">Right XML</span>
            <span 
              v-if="rightError" 
              class="text-[11px] font-bold text-rose-600 font-mono bg-rose-50 px-2 py-0.5 rounded-md border border-rose-200 animate-in fade-in"
            >
