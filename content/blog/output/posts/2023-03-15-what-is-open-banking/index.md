...
![Open Banking](/images/2023-03-15-what-is-open-banking/image-2.png "Open Banking")
...
Payment Services Directive, [PSD2](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=celex%3A32015L2366) is EU law which compels banks to allow registered third parties access consumer accounts. This facilitates innovation.

PSD2 also seeks to protect consumers by mandating stronger security through multi-factor authentication for user login.

PSD2 is integral to the growth of Open Banking within the EU as it mandates banks to make their customers financial data available via APIs to registered third party vendors. You can read more about PSD2 [here](https://davegarry.com/what-is-psd2/)
