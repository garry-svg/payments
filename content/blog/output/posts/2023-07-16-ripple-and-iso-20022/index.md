...
[Ripple](https://ripple.com/) is a technology company that leverages decentralised block chain technology in order to facilitate cheaper and faster cross-border payments. [ISO 20022](https://davegarry.com/what-is-iso-20022/) is the common language and model for financial messages being exchanged across the world. This blog post discusses what Ripple is and its adoption of ISO 20022.

## What is Ripple?

![Ripple and ISO 200222](/images/2023-07-16-ripple-and-iso-20022/image.png "Ripple and ISO 200222")

Ripple is a [RTGS](https://davegarry.com/what-is-real-time-gross-settlement/), currency exchange and remittance network that is available to financial institutions. It uses cryptocurrency to power cross-border transactions.

Ripple was designed to be a replacement for the [SWIFT](https://davegarry.com/who-are-swift/) network. It facilitates the transfer of a number of fiat currencies and cryptocurrencies between financial institutions for a small amount of XRP. This fee is small in comparison to the amount charged by banks for cross-border payments.
